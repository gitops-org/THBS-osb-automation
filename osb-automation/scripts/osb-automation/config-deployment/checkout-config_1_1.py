...
def checkout_config(args):
	#inputs	
	bb_repo_name=args[1]
	bb_config_path=args[2]
	bb_type="branch"
	bb_branch_name=args[3]
	servicename = args[4]
	
	checkout_config_bb_url = "ssh://git@code.airtelworld.in:7999/intosb"
	checkout_config_repo = "integrationreleaseosb"
	checkout_config_path = "/servicesconfig/"+servicename
	bitbucket_version_type = "branch"
	bitbucket_version_name = "Dev"	
	
	
	checkout_config_repo = bb_repo_name
	checkout_config_path = bb_config_path+servicename
	bitbucket_version_type = bb_type
	bitbucket_version_name = bb_branch_name	
	checkout_env = servicename	
	
	checkout_path = "/home/automation/deploymentAutomation/scripts/osb-automation/service-config"
